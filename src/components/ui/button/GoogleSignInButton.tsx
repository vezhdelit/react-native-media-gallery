...
const GoogleSignIn = ({ FIREBASE_AUTH }: GoogleSignInProps) => {
  GoogleSignin.configure({
    webClientId:
      "498549669670-92t97pmd31hp9v64a1tn7cf549u5ufgt.apps.googleusercontent.com",
  });
  ...
  return (
    <View>
      <TouchableOpacity
        ...
        className="flex w-full flex-row items-center justify-center space-x-2 rounded-lg bg-sky-500 p-4"
      >
